                    ...
                    <Col>
                        ...
                        <Form onSubmit={adicionarAlbum}>
                            <Form.Group className="mb-3" controlId="formAlbum">
                                ...
                                <Form.Control type="text" placeholder="Digite o nome" value={novoAlbum.nome} onChange={(e) => setNovoAlbum({ ...novoAlbum, nome: e.target.value })} required />

                                <Form.Label>Ano</Form.Label>
                                <Form.Control type="number" placeholder="Digite o ano" value={novoAlbum.ano || ''} onChange={(e) => setNovoAlbum({ ...novoAlbum, ano: e.target.value ? parseInt(e.target.value) : null })} required />
